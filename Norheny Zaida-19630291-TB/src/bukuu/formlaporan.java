...
public class formlaporan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("LAPORAN DATA BUKU");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
            Desktop.getDesktop().browse(new URL("http://localhost:81/penjualan_buku/tbl_tmp_beli.php").toURI());
            } catch (Exception e){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try{
            Desktop.getDesktop().browse(new URL("http://localhost:81/penjualan_buku/lappenjualan.php").toURI());
            } catch (Exception e){
                System.out.println(e);
            }
